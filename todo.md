...
제공되는 키는 사내망에서만 사용 가능

AOAI_ENDPOINT=https://skcc-atl-dev-openai-01.openai.azure.com/
AOAI_API_KEY=5kWBVPecvaqFeiB3PJYXnfkMHclg66duBhVXY5lWE9z187WonAnAJQQJ99BBACYeBjFXJ3w3AAABACOGqwfl
...
*** 우클릭으로 복사/붙여넣기 메뉴를 사용하세요 ***
Linux atl-streamlit-env-547477ccfc-fsf6x 5.15.0-1098-azure #107-Ubuntu SMP Thu Oct 2 22:41:20 UTC 2025 x86_64
...
Last login: Tue Dec  2 04:18:16 2025 from 10.244.3.196
export LANG=ko_KR.UTF-8
export AOAI_ENDPOINT=https://skcc-atl-dev-openai-01.openai.azure.com/
export AOAI_API_KEY=5kWBVPecvaqFeiB3PJYXnfkMHclg66duBhVXY5lWE9z187WonAnAJQQJ99BBACYeBjFXJ3w3AAABACOGqwfl
...
cd 63
05507@atl-streamlit-env-547477ccfc-fsf6x:~$ export LANG=ko_KR.UTF-8
l-dev-openai-01.openai.azure.com/c-fsf6x:~$ export AOAI_ENDPOINT=https://skcc-atl
PJYXnfkMHclg66duBhVXY5lWE9z187WonAnAJQQJ99BBACYeBjFXJ3w3AAABACOGqwflVPecvaqFeiB3P
-mini@atl-streamlit-env-547477ccfc-fsf6x:~$ export AOAI_DEPLOY_GPT4O_MINI=gpt-4o-
05507@atl-streamlit-env-547477ccfc-fsf6x:~$ export AOAI_DEPLOY_GPT4O=gpt-4o
t-embedding-3-large-env-547477ccfc-fsf6x:~$ export AOAI_DEPLOY_EMBED_3_LARGE=text
t-embedding-3-small-env-547477ccfc-fsf6x:~$ export AOAI_DEPLOY_EMBED_3_SMALL=text
bedding-ada-002mlit-env-547477ccfc-fsf6x:~$ export AOAI_DEPLOY_EMBED_ADA=text-emb
05507@atl-streamlit-env-547477ccfc-fsf6x:~$ cd 63